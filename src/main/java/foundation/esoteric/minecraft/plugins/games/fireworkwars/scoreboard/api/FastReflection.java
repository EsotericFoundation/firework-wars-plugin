package foundation.esoteric.minecraft.plugins.games.fireworkwars.scoreboard.api;
...
@SuppressWarnings(value = {"unused", "unsafe"})
public final class FastReflection {
    ...
    public static String nmsClassName(String packageName, String className) {
        if (NMS_REPACKAGED) {
            String classPackage = packageName == null ? NM_PACKAGE : NM_PACKAGE + '.' + packageName;
    ...
    public static Class<?> nmsClass(String packageName, String className) throws ClassNotFoundException {
        return Class.forName(nmsClassName(packageName, className));
    }

    public static Optional<Class<?>> nmsOptionalClass(String packageName, String className) {
        return optionalClass(nmsClassName(packageName, className));
    }
    ...
    static Class<?> innerClass(Class<?> parentClass, Predicate<? super Class<?>> classPredicate) throws ClassNotFoundException {
